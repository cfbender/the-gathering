defmodule TheGatheringWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use TheGatheringWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use TheGatheringWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import TheGatheringWeb.ConnCase
    end
  end
